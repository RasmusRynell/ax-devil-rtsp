...
class VideoGStreamerClient:
    ...
    def __init__(
        ...
        :param stream_session_metadata_callback: A callback receiving session-level metadata dicts:
        ...
        self.stream_session_metadata_callback = stream_session_metadata_callback
    ...
    def _on_pad_added(self, src: Gst.Element, pad: Gst.Pad) -> None:
        ...
        if self.stream_session_metadata_callback:
            self.stream_session_metadata_callback(parse_session_metadata(metadata))
    ...
    def _on_sdes_notify(self, src: Gst.Element, pspec) -> None:
        ...
        if self.stream_session_metadata_callback:
            self.stream_session_metadata_callback({"sdes": sdes_data})
...
def run_video_client_simple_example(
    ...
    client = VideoGStreamerClient(
        ...
        stream_session_metadata_callback=application_data_callback,
